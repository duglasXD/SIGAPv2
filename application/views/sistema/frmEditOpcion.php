    ...
    <div class="col-12">
        <div class="card ">
            <div class="card-body wizard-content">
                    <h4 class="card-title">Editar Opci&oacute;n del Sistema</h4>
                    <h6 class="card-subtitle">Edici&oacute;n de Opci&oacute;n del Sistema paso a paso</h6>
                                        ...
                                        <div class="row">
                                                <div class="col-md-6">
                                                        <div class="form-group">
                                                                ...
                                                                <input style="text-transform:uppercase" class="form-control required" value="<?php echo $item['NOMBRE_OPCION_SISTEMA'];?>"  maxlength="50" id="nombreOpcion" name="nombreOpcion"  type="text"> 
                                                        </div>
                                                </div>
                                                <div class="col-md-6">
                                                        <div class="form-group">
                                                                <label for="rutaOpcion">Ruta:</label>
                                                                <input  class="form-control" value="<?php echo $item['RUTA_OPCION_SISTEMA']; ?>"  maxlength="150" id="rutaOpcion" name="rutaOpcion"  type="text"> 
                                                        </div>
                                                </div>
                                         ...
                                         <div class="row">
                                                <div class="col-md-6">
                                                        <div class="form-group">
                                                                ...
                                                                <select style="width: 100%" class="form-control" onchange="dependencia()"  id="nivelOpcion"  name="nivelOpcion" required="true">
                                                ...
                                                <div class="col-md-6">
                                                        <div class="form-group">
                                                                ...
                                                                <select style="width: 100%" id="dependenciaOpcion"  required="true" class="form-control" name="dependenciaOpcion" required="true">
