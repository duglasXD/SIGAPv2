                                ...
                                <div class="row">
                                        <div class="col-md-6">
                                                <div class="form-group">
                                                        ...
                                                        <input   disabled="true" class="form-control "  value=" <?PHP echo $item['NUMERO_ASOCIACION']; ?> "  maxlength="25" id="numeroAsociacion" name="numeroAsociacion"  type="text"> 
                                         ...
                                         <div class="col-md-6">
                                                <div class="form-group">
                                                        ...
                                                        <input   class="form-control " value=" <?PHP echo $item['SIGLAS_ASOCIACION']; ?> "  maxlength="25"  id="siglasAsociacion" name="siglasAsociacion" type="text"> 
                                ...
                                <div class="row">
                                        <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input   required="true" value=" <?PHP echo $item['NOMBRE_ASOCIACION']; ?> "  class="form-control " maxlength="200" id="nombreAsociacion"  name="nombreAsociacion" type="text">
                                        ...
                                        <div class="col-md-6">
                                               <div class="form-group">
                                                    ...
                                                    <input   value=" <?PHP echo $item['INSTITUCION_PERTENECE_ASOCIACION']; ?> " class="form-control" maxlength="50" id="institucionAsociacion"   name="institucionAsociacion" type="text">
                                               </div>
                                        </div>
                                </div>
                                ...
                                <div class="row">
                                        <div class="col-md-6">
                                                <div class="form-group">
                                                        ...
                                                        <select   style="width: 100%" class="form-control" onchange="cambio()" value=" <?PHP echo $item['ID_SECTOR_ASOCIACION']; ?> " id="sectorAsociacion"  name="sectorAsociacion" required="true">
                                        ...
                                        <div class="col-md-6">
                                                <div class="form-group">
                                                        ...
                                                        <select   style="width: 100%" id="tipoAsociacion" value=" <?PHP echo $item['ID_TIPO_ASOCIACION']; ?> " required="true" onchange="dependencia()" class="form-control" name="tipoAsociacion" required="true">
                                ...
                                <div class="row">
                                        <div class="col-md-6">
                                                <div class="form-group">
                                                        ...
                                                        <select   style="width: 100%"  id="claseAsociacion" class="form-control" value=" <?PHP echo $item['ID_CLASE_ASOCIACION']; ?> " name="claseAsociacion" required="true" type="text">
                                        ...
                                        <div class="col-md-6">
                                                <div class="form-group">
                                                        ...
                                                        <select   style="width: 100%" class="form-control" id="dependenciaAsociacion" value=" <?PHP echo $item['AFILIACION_ASOCIACION']; ?> "  name="dependenciaAsociacion" >
                                ...
                                <div class="row">
                                        ...
                                        <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input  class="form-control" maxlength="50" value=" <?PHP echo trim($item['EMAIL_ASOCIACION']); ?> " id="emailAsociacion"  name="emailAsociacion" type="text"> 
                                                </div>
                                        </div>
                                </div>
                                 <div class="row">
                                        <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <input   value="<?PHP echo $item['HOMBRES_ASOCIACION']; ?>" class="form-control" id="hombresAsociacion" name="hombresAsociacion"  min="0"    type="number">        
                                                </div>
                                        </div>
                                        <div class="col-md-3">
                                                <div class="form-group"> 
                                                    <label for="mujeresAsociacion">Mujeres: </label>                                                       
                                                    <input   value="<?PHP echo $item['MUJERES_ASOCIACION']; ?>" class="form-control" id="mujeresAsociacion" name="mujeresAsociacion"   min="0"    type="number">      
                                                </div>  
                                        </div>
                                        <div class="col-md-6">
                                                <div class="form-group"> 
                                                    <label for="telefonoAsociacion">Teléfono: *</label>
                                                    <input   class="form-control" id="telefonoAsociacion" value=" <?PHP echo $item['TELEFONO_ASOCIACION']; ?> " required="true" name="telefonoAsociacion">
                                                </div>
                                        </div>
                               </div>
                               <div class="row">
                                        <div class="col-md-12">
                                                <div class="form-group"> 
                                                    ...
                                                    <textarea   class="form-control "   id="direccionAsociacion"  name="direccionAsociacion"><?php echo trim($item['DIRECCION_ASOCIACION']); ?></textarea>  
                                 ...
                                 <div class="row">
                                        <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input   class="form-control " value=" <?PHP echo $item['FECHA_CONSTITUCION_ASOCIACION']; ?> " id="fechaConstitucionAsociacion"  name="fechaConstitucionAsociacion" type="text">           
                                                </div>
                                        </div>
                                        <div class="col-md-6">
                                                <div class="form-group">
                                                    <label for="resolucionFinal">Fecha de Resolución Final</label>
                                                    <input   class="form-control " value=" <?PHP echo $item['FECHA_RESOLUCION_FINAL_ASOCIACION']; ?> " id="resolucionFinal" name="resolucionFinal"  required="true" type="text"> 
                                                </div>
                                        </div>
                                </div>
                                <div class="row">
                                        <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <input   value=" <?PHP echo $item['LIBRO_ASOCIACION']; ?> " class="form-control" id="numeroLibro" name="numeroLibro"  type="text">        
                                                </div>
                                        </div>
                                        <div class="col-md-3">
                                                <div class="form-group"> 
                                                    <label for="folioAsociacion">Folio: </label>                                                       
                                                    <input   value=" <?PHP echo $item['FOLIO_ASOCIACION']; ?> " class="form-control" id="folioAsociacion" name="folioAsociacion"   type="text">      
                                                </div>  
                                        </div>
                                        <div class="col-md-3">
                                                <div class="form-group"> 
                                                    <label for="regAsociacion">Reg.: </label>
                                                    <input   value=" <?PHP echo $item['REG_ASOCIACION']; ?> " class="form-control" id="regAsociacion" name="regAsociacion"  type="text">      
                                                </div>                                                           
                                        </div>
                                        <div class="col-md-3">
                                                <div class="form-group">
                                                    <label for="articuloAsociacion">Artículo: </label>                                                       
                                                    <input   value=" <?PHP echo $item['ARTICULO_ASOCIACION']; ?> " class="form-control" id="articuloAsociacion" name="articuloAsociacion"  type="text">      
                                                </div>
                                        </div>
                                </div>
                                <input type="hidden" name="num" value="<?PHP echo $item['NUMERO_ASOCIACION']; ?>">
...
<script type="text/javascript">
   ...
   function ok() {
                var url = "<?php echo site_url(); ?>/Asociacion/editAsociacion";
                $.ajax({                        
                   type: "POST",                 
                   url: url,                     
                   data: $("#save").serialize(), 
