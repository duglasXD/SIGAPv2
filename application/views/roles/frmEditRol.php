    ...
    <div class="col-12">
        <div class="card ">
            <div class="card-body wizard-content">
                    ...
                    <h6 class="card-subtitle">Edici&oacute;n de Rol paso a paso</h6>
                                            ...
                                            <div class="row">
                                                    <div class="col-md-6">
                                                            <div class="form-group">
                                                                    ...
                                                                    <input style="text-transform:uppercase" class="form-control required" value="<?php echo $item['NOMBRE_ROL_USUARIO']; ?>" maxlength="50" id="nombreRol" name="nombreRol"  type="text"> 
                                                            </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                            <div class="form-group">
                                                                    <label for="descripcionRol">Descripcion:</label>
                                                                    <input  class="form-control required"  maxlength="150" id="descripcionRol" name="descripcionRol" value="<?php echo $item['DESCRIPCION_ROL_USUARIO']; ?>" type="text"> 
                                                            </div>
                                                    </div>
