                                ...
                                <div class="row">
                                        <div class="col-md-12">
                                                <div class="form-group">
                                                        ...
                                                        <input style="text-transform:uppercase" class="form-control required"  maxlength="50" id="nombreDocumento" value="<?php echo $item['NOMBRE_DOCUMENTO']; ?>" name="nombreDocumento"  type="text"> 
                                                </div>
                                        </div>
                                 ...
                                 <div class="row">
                                     <div class="col-md-4">
                                                <div class="form-group">
                                                        ...
                                                        <select style="width: 100%" class="form-control" id="tipoDocumento"  name="tipoDocumento" required="true">
                                        ...
                                        <div class="col-md-4">
                                                <div class="form-group">
                                                        ...
                                                        <select style="width: 100%" class="form-control" id="estadoDocumento"  name="estadoDocumento" required="true">
                                        ...
                                        <div class="col-md-4">
                                                <div class="form-group">
                                                        ...
                                                        <select style="width: 100%" class="form-control" id="accesoDocumento"  name="accesoDocumento" required="true">
                                     ...
                                     <div class="col-lg-12 col-md-12">
                                        <div class="card">
                                            <div class="card-body">
                                                ...
                                                <input type="file" id="userfile" class="dropify" data-default-file='<?php echo site_url().$item['RUTA_DOCUMENTO']; ?>' name="userfile">
                                            </div>
                                        </div>
                                    </div>                                       
                                </div>
                                  ...
                                  <div class="col-md-8" align="right">
                                     ...
                                     <div class="col-md-4" align="right" >
                                       <div class="form-group">
                                        ...
                                        <input type="submit" class="btn waves-effect waves-light btn-info"  value="Editar" >
                                      </div>
                                    </div>
                                </div>
